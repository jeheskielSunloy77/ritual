...
export default function AppTabs() {
  ...
  let activeIndexVal = 1; // Default is Home (index 1 in web layout)
        ...
        <View onLayout={onLayout} style={styles.tabItemsContainer}>
          ...
          <Pressable onPress={() => navigateTo('analytics')} style={styles.tabItem}>
            <Animated.View style={[styles.tabContent, analyticsTabStyle]}>
              <MaterialIcons name="insights" size={22} color={activeTab === 'analytics' ? '#944a19' : '#54433a'} />
              <ThemedText style={[styles.tabText, { color: activeTab === 'analytics' ? '#944a19' : '#54433a' }]}>Analytics</ThemedText>
            </Animated.View>
          </Pressable>
          ...
          <Pressable onPress={() => navigateTo('home')} style={styles.tabItem}>
            <Animated.View style={[styles.tabContent, homeTabStyle]}>
              <MaterialIcons name="home" size={22} color={activeTab === 'home' ? '#944a19' : '#54433a'} />
              <ThemedText style={[styles.tabText, { color: activeTab === 'home' ? '#944a19' : '#54433a' }]}>Home</ThemedText>
            </Animated.View>
          </Pressable>
          ...
          <Pressable onPress={() => navigateTo('habits')} style={styles.tabItem}>
            <Animated.View style={[styles.tabContent, habitsTabStyle]}>
              <MaterialIcons name="person" size={22} color={activeTab === 'habits' ? '#944a19' : '#54433a'} />
              <ThemedText style={[styles.tabText, { color: activeTab === 'habits' ? '#944a19' : '#54433a' }]}>Me</ThemedText>
            </Animated.View>
          </Pressable>
        </View>
      </Neumorphic>
